...
namespace WalletConnectSharp.Core
{
    public class WalletConnectProvider : WalletConnectProtocol
    {
        ...
        public WalletConnectProvider(string url, ITransport transport = null, ICipher cipher = null, int chainId = 56, EventDelegator eventDelegator = null) : base(transport, cipher, eventDelegator)
        {
